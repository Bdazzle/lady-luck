...
const Sun = () =>{
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" height="200px" width="200px" version="1.1" id="Capa_1" viewBox="0 0 200.541 200.541" xmlSpace="preserve">
                    <g id='outer_sun'
                    className={`origin-center animate-reverseSpin`}
                    >
                        <g>
                            <path fill="#FCDD66" d="
                        M141.804,200.541l-42.877-34.198c-0.931-0.741-1.084-2.098-0.341-3.028       
                        ...
                        <g>
                            <path fill="#FCDD66" d="
                        M35.884,102.426c-0.634,0-1.261-0.277-1.686-0.811L0,58.736l52.778-5.958L58.736,0       
                        ...
                        <g>
                            <path fill="#FDE8A2" d="
                        M164.656,102.426c-0.471,0-0.945-0.153-1.342-0.471c-0.932-0.741-1.084-2.098-0.342-3.028       
                        ...
                        <g>
                            <path fill="#FDE8A2" d="
                        M58.736,200.541l-5.957-52.778L0,141.805l34.198-42.878c0.741-0.93,2.098-1.086,3.028-0.341     
